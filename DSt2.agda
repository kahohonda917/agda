...
data same-pframe {var : typ → Set}:
 ...
 App₁ : {τ β γ ε τ₂ τ₃ τ₃' τ₄ τ₄' τ₅ τ₅' : typ}{μ₁ μ₂ μβ μβ' μγ μγ' με : trail}
        {μ[β]ε : trails[ μβ ] με}
        {μ[β]γ : trails[ μβ ] μγ}
        {μ[β]γ' : trails[ μβ ] μγ'}
        ...
        same-pframe {τ₁ = τ₂ ⇒ τ₄ ⟨ μ[β]γ ⟩ τ₅ ⟨ μβ ⟩ β}
                    ...
                    {μβ = μβ}{μβ' = μβ}{μγ = μγ}{μγ' = μγ'}
                    {μ[β]α = μ[β]ε}{μ[β']α' = μ[β]ε}{μ[δ]γ = μ[β]γ}{μ[δ']γ' = μ[β]γ'}
                    (App₁ e₂) (App₁ e₂)
 ...
 App₂ : {τ₁ τ₂ α β τ₃ τ₃' δ : typ}{μα μ₁ μ₂ μβ μβ' μδ : trail}
        ...
        (v₁ : value[ var ] (τ₂ ⇒ τ₁ ⟨ μ[β]α ⟩ α ⟨ μβ ⟩ β )) →
        same-pframe {τ₃ = τ₃}{τ₃' = τ₃'}{μ[β]α = μ[β]β}{μ[β']α' = μ[β]β} (App₂  v₁) (App₂ v₁)

 Plus₁ : {α β γ τ₃ τ₃' : typ} {μα μβ μγ μβ' : trail}
         {μ[β]α : trails[ μβ ] μα}{μ[β]β : trails[ μβ ] μβ}{μ[β']β : trails[ μβ' ] μβ}
         {μ[β']α : trails[ μβ' ] μα} →
         (e₂ : term[ var ] Nat ⟨ μ[β]α ⟩ α ⟨ μβ ⟩ β) →
         same-pframe {τ₃ = τ₃}{τ₃' = τ₃'}{μβ = μβ}{μβ' = μβ'}
